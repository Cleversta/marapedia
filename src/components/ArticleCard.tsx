...
export default function ArticleCard({ article, hideImage = false }: Props) {
  ...
  return (
    ...
    >
      <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden
        ...
        {/* Thumbnail — hidden for categories that set hideImage */}
        {!hideImage && (
...
/>
            ...
            <div className="relative h-20 flex-shrink-0 bg-gradient-to-br from-gray-50 to-gray-100
              ...
              {cat.icon}
<div className="absolute top-2 right-2" onClick={e => e.preventDefault()}>
  <FavoriteButton articleId={article.id} variant="overlay" className="opacity-100" />
</div>
            </div>
          )
        )}
        ...
        <div className="p-4 flex flex-col flex-1 gap-2">
          ...
          {/* Category pill + Favorite (when image hidden) */}
