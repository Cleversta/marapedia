...
export const CATEGORIES: { value: Category; label: string; icon: string; color: string; href?: string }[] = [
  ...
  { value: 'about',    label: 'About',             icon: '📌', color: 'bg-cyan-50 text-cyan-800 border-cyan-200' },
  { value: 'knowledge', label: 'Knowledge',        icon: '📚', color: 'bg-lime-50 text-lime-800 border-lime-200' },
