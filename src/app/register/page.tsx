    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="bg-white border border-gray-200 rounded-2xl p-8 w-full max-w-md shadow-sm">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2.5 py-2.5 bg-[#4285F4] hover:bg-[#357ae8] text-white rounded-lg text-sm font-medium transition-colors mb-4 shadow-sm"
        >
